...
void CTriObject::CalcNormal(int entry, float out [ 3 ])
{
	float v1[3],v2[3];
...
void CTriObject::ReduceToUnit(float vector [ 3 ])
{
	float length;
...
int CTriObject::addMaterial(tMaterial * _material)
{
	tMaterial * tmp;
	nummaterials++;
